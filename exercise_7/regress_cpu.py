...
LastEditTime: 2021-10-27 16:16:01
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: \exercise_7\regress_cpu.py
'''
import numpy as np
import pandas as pd
...
def get_data(filename):
    ...
    sysinfo[y_column] = sysinfo['temperature'].shift(periods=-1) # should be the temperature value from the next row, t+1
