'''
Author: your name
Date: 2021-11-09 12:04:12
LastEditTime: 2021-11-11 18:30:38
LastEditors: Please set LastEditors
Description: 
FilePath: \spark-3.2.0-bin-hadoop2.7\weather_etl.py
'''
import sys
...
def main(in_directory, out_directory):
    ...
    weather = weather.withColumn("tmax",functions.col("value")/10)
